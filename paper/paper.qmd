...
The unified architecture in [`LoveModel`](../src/lovebug/unified_mesa_model.py:559) enables controlled "knockout" experiments by systematically manipulating mechanism strength:
...
Integrated experiments use [`LoveModel`](../src/lovebug/unified_mesa_model.py:559) to explore mechanism interactions through [`LayerActivationConfig`](../src/lovebug/layer_activation.py):
...
| **Weighted Layer Blending** | $P_{\text{eff}} = w_g P_g + w_c P_c$ | [`LoveAgents._update_effective_preferences()`](../src/lovebug/unified_mesa_model.py:158) | Weights: 0.0-1.0 |
...
| **Prestige-Biased Learning** | $P(\text{copy}\|i) \propto \text{prestige}(i)$ | [`LoveAgents._update_prestige_scores()`](../src/lovebug/unified_mesa_model.py:410) | Mating success weighting |
...
Our vectorized implementation in [`LoveModel`](../src/lovebug/unified_mesa_model.py) achieves population scales unprecedented in sexual selection modeling:
